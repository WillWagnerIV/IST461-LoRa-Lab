...
const String ssid = "SingleDigits-Guest";
const String password = "";
const String orgID = "8uwbrv";
const String devType = "Hay-Sensor";
const char* authToken = "G*YdU!iY3ft9!biv5d";   // Use the same token for all the devices for simplicity.
...
void sendMessage(int chipID, int temp, int humidity) {
  ...
  Serial.printf("Starting Send Message");
...
void processLoRaPacket(int packetSize) {
  ...
  Serial.printf("packet info:  /%d/%d/%d  ",&chipID, &temp, &humidity);
